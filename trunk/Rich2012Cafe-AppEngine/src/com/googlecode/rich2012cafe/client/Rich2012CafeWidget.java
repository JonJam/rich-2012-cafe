...
public class Rich2012CafeWidget extends Composite {
  ...
  interface Rich2012CafeUiBinder extends UiBinder<Widget, Rich2012CafeWidget> {
  }

  private static Rich2012CafeUiBinder uiBinder = GWT.create(Rich2012CafeUiBinder.class);
